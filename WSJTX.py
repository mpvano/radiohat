...
# Title: Wsjtx
# Generated: Sun Oct 10 18:18:48 2021
##################################################
...
class WSJTX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wsjtx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wsjtx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "WSJTX")
        ...
        self.audio_source_1 = audio.source(samp_rate, 'fromWSJTXtoGRC', True)
        self.audio_source_0 = audio.source(samp_rate, 'toGRCfromHat', True)
        ...
        self.connect((self.audio_source_1, 0), (self.blocks_mute_xx_1, 0))
...
def main(top_block_cls=WSJTX, options=None):
