...
# Title: Usbheadset
# Generated: Fri Oct 15 20:31:54 2021
##################################################
...
class USBHeadset(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Usbheadset")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Usbheadset")
        ...
        self.settings = Qt.QSettings("GNU Radio", "USBHeadset")
        ...
        self.analog_agc2_xx_1 = analog.agc2_ff(1e-1, 1e0, .5, 0.8)
...
def main(top_block_cls=USBHeadset, options=None):
