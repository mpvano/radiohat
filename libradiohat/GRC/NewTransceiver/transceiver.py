...
class transceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(1, 2):
            self.RXTXTabs_grid_layout_0.setColumnStretch(c, 1)
        self._VFO_range = Range(3500, 32000000, 100, 7074000, 200)
        ...
        self.connect((self.analog_agc2_xx_0, 0), (self.blocks_add_xx_2, 0))
        self.connect((self.analog_agc2_xx_0, 0), (self.blocks_add_xx_3, 0))
