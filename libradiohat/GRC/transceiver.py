...
class transceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.RXTXTabs_grid_layout_0.addWidget(self._rxbalance_win, 1, 2, 1, 1)
        for r in range(1, 2):
        ...
        for c in range(1, 2):
            self.RXTXTabs_grid_layout_0.setColumnStretch(c, 1)
        self._VFO_range = Range(3500, 32000000, 100, 7074000, 400)
        self._VFO_win = RangeWidget(self._VFO_range, self.set_VFO, 'VFO', "counter", int)
        self.RXTXTabs_grid_layout_0.addWidget(self._VFO_win, 3, 0, 1, 1)
        for r in range(3, 4):
            self.RXTXTabs_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 1):
            self.RXTXTabs_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.RXTXTabs_grid_layout_0.addWidget(_LSB_check_box, 0, 2, 1, 1)
        for r in range(0, 1):
            self.RXTXTabs_grid_layout_0.setRowStretch(r, 1)
        for c in range(2, 3):
            self.RXTXTabs_grid_layout_0.setColumnStretch(c, 1)
        ...
        for c in range(1, 2):
            self.RXTXTabs_grid_layout_0.setColumnStretch(c, 1)
        self._Gain_range = Range(0.03, 5, .05, 2.5, 5)
        ...
        self.RXTXTabs_grid_layout_0.addWidget(self._qtgui_freq_sink_x_0_win, 2, 0, 1, 3)
        for r in range(2, 3):
            self.RXTXTabs_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 3):
            self.RXTXTabs_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.hilbert_fc_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.hilbert_fc_0, 0))
